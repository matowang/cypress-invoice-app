...
describe("/clients/*", () => {
    ...
    it("can edit existing client", () => {
        ...
        cy.get(`[data-test="client-company-name"]`).clear().type(`updated ${NEW_CLIENT_DETAILS.companyName}`)
        cy.get(`[data-test="client-company-address"]`).clear().type(`updated ${NEW_CLIENT_DETAILS.companyAddress}`)
        ...
        cy.get(`[data-test="client-company-swift"]`).clear().type(`updated ${NEW_CLIENT_DETAILS.swift}`)
        ...
        cy.get(`[data-test*="client-row"]:first [data-test="client-name"]`).contains(`updated ${NEW_CLIENT_DETAILS.name}`)
        cy.get(`[data-test*="client-row"]:first [data-test="client-companyName"]`).contains(`updated ${NEW_CLIENT_DETAILS.companyName}`)
