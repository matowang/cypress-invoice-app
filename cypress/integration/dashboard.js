describe('/dashboard', () => {
    ...
    it("dashboard has relevant data for fake_user1", () => {
        ...
        cy.get(`[data-test*="client-row"]:first [data-test="client-companyName"]`).contains("Wonderland")

        cy.get(`[data-test*="client-row"]:nth-child(2) [data-test="client-name"]`).contains("John")
        cy.get(`[data-test*="client-row"]:nth-child(2) [data-test="client-companyName"]`).contains("Skynet 2")
